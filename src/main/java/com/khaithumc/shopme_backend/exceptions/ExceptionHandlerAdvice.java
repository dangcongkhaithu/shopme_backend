...
//	}
	...
	@ExceptionHandler(com.khaithumc.shopme_backend.exceptions.ValidationException.class)
	public ResponseEntity<ApiResponse> validationException(com.khaithumc.shopme_backend.exceptions.ValidationException ex){
		String message = ex.getMessage();
